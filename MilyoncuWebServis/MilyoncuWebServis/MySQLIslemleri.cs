...
namespace MilyoncuWebServis
{
    public class MySQLIslemleri
    {
        ...
        {
            baglanti = new MySqlConnection("Server=94.73.150.250;Database=teknokentportal;Uid=hikmetyucel.net;Pwd=Odtu1997; pooling=false;");

            baglanti.Open();
        }

        public void IM_MySQLBaglatiAc(string str_connection_string)
        {
            baglanti = new MySqlConnection(str_connection_string);
